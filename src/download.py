...
## python3 download.py -H localhost -p 8888 -n test -d client_files -v
def main():
    ...
    try:
        protocols.recive_stop_and_wait(clientSocket, args.host, server_port, file_name_dst, dest_file_path)
